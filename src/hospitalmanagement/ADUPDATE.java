...
public class ADUPDATE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Admin Doctor Update Form");
        ...
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 520, 139, 25));
        jPanel2.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 520, 213, -1));
        jPanel2.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 520, 216, -1));

        jLabel15.setFont(new java.awt.Font("Monotype Corsiva", 0, 36)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 51, 204));
        jLabel15.setText("                 Update Doctor");
        ...
        jPanel2.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 90, -1, -1));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            ...
            if (i > 0){
                JOptionPane.showMessageDialog(null, "Doctor Details Successfully Updated");
            }
            else {
