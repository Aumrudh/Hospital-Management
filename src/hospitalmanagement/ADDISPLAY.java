...
public class ADDISPLAY extends javax.swing.JFrame {
    ...
    public ADDISPLAY() {
        ...
        try{
                ...
                tm.setRowCount(0);
                while(rs.next()){
                    Object obj[] = {rs.getInt("SSN"),rs.getString("fname"),rs.getString("lname"),rs.getString("dob"),rs.getString("bloodgroup"),rs.getString("gender"),rs.getString("dept"),rs.getInt("age"),rs.getString("maritialstatus"),rs.getString("mobileno"),rs.getInt("experience"),rs.getString("address"),rs.getString("username"),rs.getString("password"),rs.getString("timing")};
                    tm.addRow(obj);
                }
            }
            catch(Exception e){
    ...
    private void initComponents() {
        ...
        setTitle("Admin Doctor Display Form");

        table1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        table1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "SSN", "First Name", "Last Name ", "D.O.B", "Blood Group", "Gender", "Dept", "Age", "Maritial Status", "Mobile No", "Experiance", "Address", "Username", "Password", "Visit Timing"
            }
        ));
